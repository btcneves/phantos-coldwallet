...
class FountainEncoder:
    def __init__(self, message, max_fragment_len, first_seq_num=0, min_fragment_len=10):
        assert len(message) <= MAX_UINT32  # nosec B101
    ...
    def find_nominal_fragment_length(message_len, min_fragment_len, max_fragment_len):
        assert message_len > 0  # nosec B101
        assert min_fragment_len > 0  # nosec B101
        assert max_fragment_len >= min_fragment_len  # nosec B101
        ...
        assert fragment_len != None  # nosec B101
        return fragment_len
